export { Command, SlashCommand, Meta, Aliases };
    import { ColorResolvable, CommandInteraction, EmbedFieldData, Message } from 'discord.js';
import { ChannelSettings, ChannelSetting, Discord, sendMessage } from '../bot.js';
...
function SlashCommand(interaction: CommandInteraction) {
    if (!interaction.options.data.some(o => o.name === 'command')) {
        interaction.editReply({
            embeds: [createHelpEmbed(helpColor, 'Commands:', [
        ...
        switch(command) {
            case "q":
                interaction.editReply({
                    embeds: [createHelpEmbed(helpColor, 'Question Commands:', [
            ...
            case "c":
                interaction.editReply({
                    embeds: [createHelpEmbed(helpColor, 'Control Commands:', [
            ...
            case "help":
                interaction.editReply({
                    embeds: [createHelpEmbed(helpColor, 'Help command', [
                        { name: '__Usage__', value: `**/help [command]**: Gives info about a specific command` }
                    ], '/')]
                })
            case "truth":
                interaction.editReply({
                    embeds: [createHelpEmbed(todColor, 'Truth command', [
            ...
            case "dare":
                interaction.editReply({
                    embeds: [createHelpEmbed(todColor, 'Dare command', [
            ...
            case "wyr":
                interaction.editReply({
                    embeds: [createHelpEmbed(wyrColor, "Would You Rather command", [
            ...
            case "nhie":
                interaction.editReply({
                    embeds: [createHelpEmbed(nhieColor, "Never Have I Ever command", [
            ...
            case "paranoia":
                interaction.editReply({
                    embeds: [createHelpEmbed(paranoiaColor, 'Paranoia command', [
            ...
            case "ans":
                interaction.editReply({
                    embeds: [createHelpEmbed(paranoiaColor, 'Answer command', [
            ...
            case "links":
                interaction.editReply({
                    embeds: [createHelpEmbed(infoColor, 'Links command', [
            ...
            case "stats":
                interaction.editReply({
                    embeds: [createHelpEmbed(infoColor, "Stats Command", [
            ...
            case "settings":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Settings command', [
            ...
            case "enable":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Enable command', [
            ...
            case "disable":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Disable command', [
            ...
            case "mute":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Mute command', [
            ...
            case "unmute":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Unmute command', [
            ...
            case "admin":
                interaction.editReply({
                    embeds: [createHelpEmbed(settingsColor, 'Admin command', [
            ...
            case "showparanoia":
                interaction.editReply({
                    embeds: [createHelpEmbed(paranoiaColor, "Show Paranoia Command", [
            ...
            case "clear":
                interaction.editReply({
                    embeds: [createHelpEmbed(paranoiaColor, "Clear Paranoia Command", [
            ...
            case "truthful":
                interaction.editReply({
                    embeds: [createHelpEmbed(todColor, "Truthful Command", [
            ...
            case "ping":
                interaction.editReply({
                    embeds: [createHelpEmbed(infoColor, "Ping Command", [
...
function createHelpEmbed(color: ColorResolvable, title: string, fields: EmbedFieldData[], prefix: string) {
